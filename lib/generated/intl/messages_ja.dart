...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m0(name) => "本当に\"${name}\"のアカウントを削除しますか?";

  static m1(pageName) => "${pageName}を開く";
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "bossDrizzler" : MessageLookupByLibrary.simpleMessage("コウモリ"),
    "bossFlyfish" : MessageLookupByLibrary.simpleMessage("カタパッド"),
    "bossGoldie" : MessageLookupByLibrary.simpleMessage("キンシャケ"),
    "bossGriller" : MessageLookupByLibrary.simpleMessage("グリル"),
    "bossMaws" : MessageLookupByLibrary.simpleMessage("モグラ"),
    "bossScrapper" : MessageLookupByLibrary.simpleMessage("テッパン"),
    "bossSteelEel" : MessageLookupByLibrary.simpleMessage("ヘビ"),
    "bossSteelhead" : MessageLookupByLibrary.simpleMessage("バクダン"),
    "bossStinger" : MessageLookupByLibrary.simpleMessage("タワー"),
